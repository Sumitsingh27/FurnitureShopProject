...
import com.furniture.testSet.BaseTestClass;
...
public class Screenshot extends BaseTestClass {
	...
	public static String getScreenshot(WebDriver driver, String result) throws IOException {
		...
		//String destination = "C:\\Users\\M1041815\\Desktop\\FailedTestsScreenshots\\" + result + dateName + "screenshot.png";
		File src = (ts.getScreenshotAs(OutputType.FILE));
		
		String destination = System.getProperty("user.dir")  + File.separator + "Screenshots\\" + result + dateName + ".png";
	...
	public static void getStepWiseScreenshot(WebDriver driver) {
		...
		try {
			test.log(Status.INFO, "Taking Step ScreenShots" , MediaEntityBuilder.createScreenCaptureFromPath(destination).build());
		} catch(IOException e) {
			e.printStackTrace();
		}
